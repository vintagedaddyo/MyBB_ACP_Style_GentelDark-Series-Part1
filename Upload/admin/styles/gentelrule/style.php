...
//]]>
    ...
    function output_footer($quit=true)
	{
        ...
        echo "            <br>";
        echo "            Gentelella Style By: <a href=\"http://www.chack1172.altervista.org\">Chack1172</a>. <br /> Gentelrule Style By: <a href=\"http://community.mybb.com/user-6029.html\">Vintagedaddyo</a>. <br /> Based On Gentelella - Bootstrap Admin Template by <a href=\"https://colorlib.com\">Colorlib</a>";
        echo "          </div>\n";
        echo "          <div class=\"clearfix\"></div>\n";
        echo "        </footer>\n";
		if($mybb->debug_mode)
...
EOF;
		...
		$login_page .= <<<EOF
                ...
                <div class="separator">
                    ...
                    <p>Gentelella Style By: <a href="http://www.chack1172.altervista.org/?language=english">Chack1172</a>. <br /> Gentelrule Style By: <a href="http://community.mybb.com/user-6029.html">Vintagedaddyo</a>. <br /> Based On Gentelella - Bootstrap Admin Template by <a href="https://colorlib.com">Colorlib</a></p>
                </div>
            </form>
        </section>
	</div>
